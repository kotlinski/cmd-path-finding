...
import se.kotlinski.deprecated.controller.graph.event.ConnectedComponentTraversalEvent;
import se.kotlinski.deprecated.controller.graph.event.EdgeTraversalEvent;
import se.kotlinski.deprecated.controller.graph.event.TraversalListener;
import se.kotlinski.deprecated.controller.graph.event.VertexTraversalEvent;
